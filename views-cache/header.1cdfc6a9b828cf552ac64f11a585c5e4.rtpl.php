...
<html lang="pt-br">
  <head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" href="/ecommerce_php7/res/site/css/bootstrap.min.css">
    
    <!-- Font Awesome -->
    <link rel="stylesheet" href="/ecommerce_php7/res/site/css/font-awesome.min.css">
    
    <!-- Custom CSS -->
    <link rel="stylesheet" href="/ecommerce_php7/res/site/css/owl.carousel.css">
    <link rel="stylesheet" href="/ecommerce_php7/res/site/css/style.css">
    <link rel="stylesheet" href="/ecommerce_php7/res/site/css/responsive.css">
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="/"><img src="/ecommerce_php7/res/site/img/logo.png"></a></h1>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="/ecommerce_php/views/">Home</a></li>
