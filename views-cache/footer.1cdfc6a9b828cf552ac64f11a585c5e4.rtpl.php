<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="footer-top-area">
    ...
    <!-- jQuery sticky menu -->
    <script src="/ecommerce_php7/res/site/js/owl.carousel.min.js"></script>
    <script src="/ecommerce_php7/res/site/js/jquery.sticky.js"></script>
    
    <!-- jQuery easing -->
    <script src="/ecommerce_php7/res/site/js/jquery.easing.1.3.min.js"></script>
    
    <!-- Main Script -->
    <script src="/ecommerce_php7/res/site/js/main.js"></script>
    
    <!-- Slider -->
    <script type="text/javascript" src="/ecommerce_php7/res/site/js/bxslider.min.js"></script>
	<script type="text/javascript" src="/ecommerce_php7/res/site/js/script.slider.js"></script>
  </body>
</html>